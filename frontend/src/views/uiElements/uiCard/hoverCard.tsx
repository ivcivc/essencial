...
const HoverCard = () => {
  return (
    <React.Fragment>
      ...
      <div className="col-span-12 sm:col-span-6 xl:col-span-3">
        <div className="relative overflow-hidden transition-all duration-500 card group/item hover:-translate-y-1 hover:shadow-2xl hover:border-purple-500/30">
          <div className="card-body">
            ...
            <div className="relative z-10 max-w-md mx-auto">
              <div className="grid text-purple-500 transition-all duration-500 bg-purple-500/10 rounded-full size-20 place-items-center">
                <MessageCircleMore className="size-8" />
              </div>
