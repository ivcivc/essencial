...
import React, { useState } from "react"; // Example for the alert-triangle icon, replace with your icon
          ...
          <div className="grid grid-cols-1 gap-2 xl:grid-cols-2">
            {alerts.map((alert) => (
              ...
              >
                ...
                <div
                  className={`flex items-center justify-center border border-${alert.color}-500/20 rounded-full size-11 shrink-0`}
                >
                  {alert.icon}
                </div>
