  ...
  return (
    <React.Fragment>
      <div className="relative">
        ...
        {isOpen && (
          <div
            className={`fixed py-3 z-[1055] text-sm text-white transition-all duration-300 ease-in-out transform rounded-md ltr:pl-5 rtl:pr-5 bg-gradient-to-r from-primary-500 to-primary-600 ltr:pr-9 rtl:pl-9 max-w-96 ${position} z-toast`}
