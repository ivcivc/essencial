                ...
                <div className="relative flex mt-4">
                  ...
                  <div className="absolute inset-y-0 items-center hidden ltr:right-1 rtl:left-1 sm:flex">
                    <button
                      type="button"
                      onClick={sendMessage}
                      className="inline-flex items-center justify-center text-white transition duration-200 ease-in-out rounded-md size-8 bg-primary-500 hover:bg-primary-600 focus:outline-none"
                    >
