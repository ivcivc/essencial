        ...
        <div className="card">
          <div className="flex flex-wrap items-center gap-3 card-body">
            ...
            <div className="grow">
              <h6 className="mb-1">
                <Link to="#!">
                  <span className="align-middle">SRBThemes Infotech LLP</span>
                ...
                <div className="flex items-center gap-2 mt-3 grow">
                  {colorOptions.map(({ color, bgColor }) => (
                    <Link
                      key={color}
                      to="#!"
                      className={`flex items-center justify-center text-white ${bgColor} rounded-sm size-5 group/item ${activeLink === color ? "active" : "p-2"}`}
                      onClick={(e) => {
                        e.preventDefault();
                        setActiveLink(color);
                      }}
