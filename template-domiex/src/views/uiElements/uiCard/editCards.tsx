          ...
          <div className="relative flex flex-col items-center justify-center w-full mb-5">
            ...
            >
              ...
              >
                ...
                <div className="flex flex-col grow mt-3 space-y-2">
                      ...
                      <div className="relative mt-4 text-center group/items">
                        {editing !== "fullname" ? (
                          ...
                          <input
                            ...
                            className="w-full p-0 px-2 m-0 font-sans text-xl font-semibold text-center text-white bg-transparent focus:outline-none focus:animate-pulse"
                            value={fullname}
                      ...
                      <div className="relative mt-1 text-center group/items">
                        {editing !== "username" ? (
                          ...
                          <input
                            ...
                            className="inline-block w-auto p-0 m-0 font-sans text-sm font-semibold text-center bg-transparent text-white/75 focus:outline-none focus:animate-pulse"
                            value={username}
