...
interface FilterDrawerProps {
  ...
  closeDrawer: () => void;
  onFilterChange: any;
  updateCountCategory: any;
  updateCountColor: any;
          ...
          <>
            <SimpleBar>
              <div className="relative group/form">
                ...
                />
                <button className="absolute inset-y-0 flex items-center text-gray-500 dark:text-dark-500 ltr:left-3 rtl:right-3 rtl ltr:group-[&.right]/form:right-3 rtl:group-[&.right]/form:left-3 ltr:group-[&.right]/form:left-auto rtl:group-[&.right]/form:right-auto focus:outline-none">
